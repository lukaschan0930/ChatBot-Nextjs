        ...
        const fetchData = async () => {
            try {
                ...
                sortedExplorer.forEach((item) => {
                    ...
                    activeUsersData.push([timestamp, item.activeUsers.length * 100 > item.userCount * 0.2 ? Math.round(item.userCount * getRandomNumber(0.1, 0.3)) : item.activeUsers.length * 100]);
