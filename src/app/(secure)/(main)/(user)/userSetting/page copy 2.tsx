                ...
                <div className="border-t border-[#25252799] p-6">
                    <div className="flex flex-col -mt-[64px]">
                        ...
                        <div className="flex gap-3 flex-col md:flex-row">
                            <div className="w-full flex flex-col gap-3 mt-9 md:pr-14">
                                <div className="flex items-start bg-[#FFFFFF05] border border-[#FFFFFF14] text-[14px] rounded-md max-md:w-full w-[300px]">
                                    <div className="bg-[#292929] px-6 py-2 border-r border-[#FFFFFF14] text-[#808080] !w-[120px] text-center">Username</div>
                                    <input
                                ...
                                <div className="flex items-start bg-[#FFFFFF05] border border-[#FFFFFF14] text-[14px] rounded-md max-md:w-full w-[300px]">
                                    <div className="bg-[#292929] px-6 py-2 border-r border-[#FFFFFF14] text-[#808080] text-nowrap !w-[120px] text-center">Invite Code</div>
