const Akash = () => {
    return (
        <svg width="25" height="22" viewBox="0 0 25 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16.4413 14.7686L20.4869 21.8587H12.3148L8.22656 14.7686H16.4413Z" fill="url(#paint0_linear_1409_34811)" />
            <path d="M20.4847 21.8607L24.5662 14.7706L16.3964 0.586914H8.22656L20.4847 21.8607Z" fill="#FF414C" />
